    ...
    <div style={{ 
      ...
      <form onSubmit={handleSubmit} style={{ 
        ...
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          ...
          <h1 style={{ margin: "0 0 8px", fontSize: "1.5rem", fontWeight: 700, color: "var(--fl-ink)" }}>Welcome back</h1>
          <p style={{ margin: "0 0 24px", fontSize: "0.9rem", color: "var(--fl-ink-3)" }}>Sign in to your FretLab account</p>
        </div>
        ...
        <div style={{ textAlign: "center", fontSize: "0.8rem", color: "var(--fl-ink-4)" }}>
          <p>Don't have an account? <Link to="/register" style={{ color: "var(--fl-accent)", textDecoration: "none" }}>Sign up</Link></p>
        </div>
        ...
        <div style={{ 
          ...
          <a href="/forgot-password" style={{ color: "var(--fl-ink-3)", fontSize: "0.8rem", textDecoration: "none" }}>Forgot password</a>
